...
ONNX_MODEL = '/ONNX/regnet1.onnx'
RKNN_MODEL = '/RKNN/regnet1.rknn'
IMG_PATH = './bus.jpg'
DATASET = './dataset.txt'
...
# CLASSES = ("wharf-grab", "block", "bury", "normal", "revolve", "rollover")
...
if __name__ == '__main__':
    ...
    # load RKNN
    print('--> loading model')
    rknn.load_rknn('/home/ubuntu/rknn-toolkit2-1.3.0/examples/onnx/yolov5/RKNN/reg_new.rknn')

    # Load ONNX model
    # print('--> Loading model')
    # ret = rknn.load_onnx(model=ONNX_MODEL, outputs=['809', '861', '913'])  # ['378', '439', '500']
    # if ret != 0:
    ...
    # np.save('./NPY/onnx_yolov5_0.npy', outputs[0])  # 输入数组存储在磁盘中
    # np.save('./NPY/onnx_yolov5_1.npy', outputs[1])
    # np.save('./NPY/onnx_yolov5_2.npy', outputs[2])
    print('done')

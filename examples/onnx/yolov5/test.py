...
ONNX_MODEL = './ONNX/yolov5s.onnx'
RKNN_MODEL = './ONNX/yolov5s.rknn'
IMG_PATH = './bus.jpg'
DATASET = './dataset.txt'
...
if __name__ == '__main__':
    ...
    # Load ONNX model
    print('--> Loading model')
    ret = rknn.load_onnx(model=ONNX_MODEL, outputs=['378', '439', '500'])  # ['378', '439', '500']
    if ret != 0:
    ...
    np.save('./onnx_yolov5_0.npy', outputs[0])  # 输入数组存储在磁盘中
